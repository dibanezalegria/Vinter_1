 ...
 */
public class ThoraxFragment extends AbstractFragment implements NotesDialogFragment.NotesDialogListener, TextWatcher {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mTestPhase == TestActivity.TEST_OUT) {
            TextView textView = (TextView) rootView.findViewById(R.id.thorax_title);
    ...
    public void helpDialog() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            dialog.setMessage(Html.fromHtml(getContext().getString(R.string.thorax_manual),
    ...
    public void notesDialog() {
        ...
        dialogFragment.setTargetFragment(ThoraxFragment.this, 100);
