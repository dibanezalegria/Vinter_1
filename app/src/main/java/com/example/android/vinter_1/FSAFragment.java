...
public class FSAFragment extends AbstractFragment implements NotesDialogFragment.NotesDialogListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mTestPhase == TestActivity.TEST_IN) {
            mRootView = inflater.inflate(R.layout.fragment_fsa_in, container, false);
        } else {
            mRootView = inflater.inflate(R.layout.fragment_fsa_out, container, false);
        }
        ...
        // Note fab
        FloatingActionButton fabNotes = (FloatingActionButton) mRootView
                .findViewById(R.id.fsa_fab_notes);
