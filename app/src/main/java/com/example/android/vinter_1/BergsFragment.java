...
public class BergsFragment extends AbstractFragment implements NotesDialogFragment.NotesDialogListener, RadioGroup.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mTestPhase == TestActivity.TEST_IN) {
            mRootView = inflater.inflate(R.layout.fragment_bergs_in, container, false);
        } else {
            mRootView = inflater.inflate(R.layout.fragment_bergs_out, container, false);
        }

        // Note fab
        FloatingActionButton fabNotes = (FloatingActionButton) mRootView.findViewById(R.id.bergs_fab_notes);
